        ...
        case TakingOff:
            {
                ...
                tf::StampedTransform transform;
                m_listener.lookupTransform(m_worldFrame, m_frame, ros::Time(0), transform);
                test_height = transform.getOrigin().z();
                ROS_INFO("Height is %0.2f", test_height);
                ...
                m_diffinput.linear.z = m_thrust_nom;
        ...
        case Landing:
            {
                ...
                m_goal.pose.position.z = m_startZ - 0.8*(1-t_landing/4.0);
                tf::StampedTransform transform;
                m_listener.lookupTransform(m_worldFrame, m_frame, ros::Time(0), transform);
                test_height = transform.getOrigin().z();
                ROS_INFO("Height is %0.2f", test_height);
